    ...
    public partial class AdminEReceipts : Form
    {
        ...
        private void txtsearchbar_TextChanged(object sender, EventArgs e)
        {
            if (txtsearchbar.Text != "")
            {
                ...
                cnn.Open();
                String sql = "Select*from EReceipt where AccNo LIKE '" + txtsearchbar.Text + "%'";
        ...
        private void btnprint_Click(object sender, EventArgs e)
        {
            ...
            printer.Title = "\r\n\r\n\r\n ZEMO Bank \r\n\r\n";
            printer.SubTitle = "E-Receipts - Admin \r\n\r\n\r\n";
            ...
            MessageBox.Show("Successfully printed", "Admin - E-Receipts", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
