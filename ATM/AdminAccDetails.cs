...
namespace ATM
{
    public partial class AdminAccDetails : Form
    {
        ...
        private void AdminAccDetails_Load(object sender, EventArgs e)
        {
            ...
            cnn.Open();
            String sql = "Select*from UserAccountDetails ";
        ...
        private void btnprint_Click(object sender, EventArgs e)
        {
            ...
            printer.Title = "\r\n\r\n\r\n ZEMO Bank \r\n\r\n";
            printer.SubTitle = "Account Details - Admin \r\n\r\n\r\n";
            ...
            MessageBox.Show("Successfully printed", "Admin - Account Details", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void txtsearchbar_TextChanged(object sender, EventArgs e)
        {
            if (txtsearchbar.Text != "")
            {
                ...
                cnn = new SqlConnection(connectionString);
                cnn.Open();
                String sql = "Select*from UserAccountDetails where AccNo LIKE '" + txtsearchbar.Text + "%'";
                SqlCommand cmd = new SqlCommand(sql, cnn);
