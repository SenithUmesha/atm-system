...
namespace ATM
{
    ...
    {
        public static string type1 = "Water Bill Payment";
        public static string type2 = "National Water Board";
                    ...
                    else
                    {
                        if (txtcpin.Text == Home.signinPin)
                        {
                            ...
                            if (status != "Yes")
                            {
                                ...
                                printer.Title = "\r\n\r\n\r\n ZEMO Bank \r\n\r\n";
                                printer.SubTitle = "Payments - National Water Board \r\n\r\n";
                            ...
                            else 
                            {
                                try
                                {
                                    ...
                                    mailMessage.Subject = "National water board bill payment receipt - ZEMO Bank";
