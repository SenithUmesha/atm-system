...
namespace ATM
{
    ...
    {
        private const string TransactionType = "Water Bill Payment";
        private const string Provider = "National Water Board";
            ...
            try
            {
                ...
                if (eReceiptEnabled && EmailService.IsConfigured)
                {
                    ...
                    emailed = EmailService.TrySendTemplate(
                        email,
                        "Water bill payment receipt - ZEMO Bank",
                        "index.html",
                        replacements,
                        out string error);
                ...
                if (!emailed)
                {
                    PrintReceipt("Payments - National Water Board");
                }
